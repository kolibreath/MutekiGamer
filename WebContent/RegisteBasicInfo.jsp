...
<head>
   ...
   <!-- <meta http-equiv="Content-Type" content="text/html" /> -->
    ...
    <title>MutekiGamer - Join Us</title>
...
<body>
    ...
    <div class="main-body">
        <div class="logContext">
            <div class="reg">
                ...
                <div class="input-form">
                    <form action="<%=request.getContextPath()%>/" method="post">
                        ...
                        <div></div>
                        <input class="element" type="email" name="email" value="" autocomplete="off" placeholder="xxxx@xxx.com">
                        <hr>
                        <div></div>
                        <b class="element">Nickname</b>
                        <div></div>
                        <input class="element" type="text" name="Nickname" value="" placeholder="use a~z, 0~9, A~Z and _">
                        <hr>
                        <div></div>
            ...
            <div class="login">
                <h1>Already a MutekiGamer Member?</h1>
                <a href="Login.jsp">
